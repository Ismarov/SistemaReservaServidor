...
public class PersonaDAO {
	...
	public static boolean save(orm.Persona persona) throws PersistentException {
		try {
			orm.VpERormPersistentManager.instance().saveObject(persona);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Persona persona) throws PersistentException {
		try {
			orm.VpERormPersistentManager.instance().deleteObject(persona);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Persona persona) throws PersistentException {
		try {
			orm.VpERormPersistentManager.instance().getSession().refresh(persona);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Persona persona) throws PersistentException {
		try {
			orm.VpERormPersistentManager.instance().getSession().evict(persona);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
